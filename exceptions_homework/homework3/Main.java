package exceptions_homework.homework3;

import java.io.IOException;

import exceptions_homework.homework3.service.FileProcessor;
import exceptions_homework.homework3.service.InputParser;

public class Main {
    public static void main(String[] args) {

        String path = "exceptions_homework/homework3/service/resources/";
